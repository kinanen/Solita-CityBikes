...
var useComboboxContext = function () { return React.useContext(ComboboxContext); };
/**
...
var useComboboxControls = function (params) {
    ...
    var _b = React.useState((params === null || params === void 0 ? void 0 : params.initialValue) || ''), value = _b[0], setValue = _b[1];
    return {
...
function useClassNameStr(className, params) {
    return React.useMemo(function () { return (!className || typeof className === 'string' ? className : className(params)); }, [params, className]);
}
/**
...
function useComboboxHelpers(_a) {
     ...
     */
    var expandOnFocus = React.useCallback(function () {
        if (!isExpandedRef.current && setIsExpanded)
            setIsExpanded(true);
    }, [setIsExpanded]);
    var handleCloseDatalist = React.useCallback(function () {
        if (isExpandedRef.current && setIsExpanded)
            setIsExpanded(false);
    }, [setIsExpanded]);
    /**
     ...
     */
    var handleFocusOutside = React.useCallback(function () {
        if (!comboboxInputRef.current || !listboxRef.current)
            return;
     ...
     */
    var handleKeyDownOnInput = React.useCallback(function (e) {
     ...
     */
    var handleKeyDownOnListboxOption = React.useCallback(function (e) {
        if (!itemsRef.current)
            return;
 ...
 */
var ComboboxInput = React.forwardRef(function (_a, forwardedRef) {
    ...
    return (React__default["default"].createElement("input", __assign({ autoComplete: "off" }, props, { ref: forwardedRef, value: value, type: "text", role: "combobox", "aria-autocomplete": "list", "aria-haspopup": "listbox", "aria-expanded": isExpanded, "aria-controls": listboxId })));
});
...
var Highlight = function (_a) {
    ...
    var markedChildren = React.useMemo(function () {
    ...
    return React__default["default"].createElement(React__default["default"].Fragment, null, markedChildren);
};
/**
 * One listbox option.
 */
var ListboxOption = React.forwardRef(function (_a, forwardedRef) {
    ...
    return (React__default["default"].createElement("li", __assign({}, props, { ref: forwardedRef, id: id, className: classNameStr, role: "option" }), children));
});
ListboxOption.displayName = 'ListboxOption';
/**
 * The combobox popup list.
 */
var Listbox = React.forwardRef(function (_a, forwardedRef) {
    var children = _a.children, props = __rest(_a, ["children"]);
    var _b = useComboboxContext(), contextAvailable = _b.contextAvailable, listboxId = _b.listboxId, isExpanded = _b.isExpanded;
    assertWithWarning(contextAvailable, contextRequiredWarning(Listbox.name));
    var isExpandedRef = React.useRef(isExpanded);
    var _c = React.useState(false), hasExpanded = _c[0], setHasExpanded = _c[1];
    ...
    return (React__default["default"].createElement("ul", __assign({}, props, { ref: forwardedRef, id: listboxId, role: "listbox", "aria-live": hasExpanded ? props['aria-live'] || 'polite' : 'off' }), children));
});
...
var useInternalValue = function (value, setValue) {
    var _a = React.useState(value || ''), internalValue = _a[0], setInternalValue = _a[1];
...
function useFilters(items, value, filters) {
    ...
    var filtered = React.useMemo(function () { return filters.reduce(function (currentItems, filter) { return filter(currentItems, value); }, items); }, [items, filters, value]);
    React.useEffect(function () {
...
var DatalistInput = React.forwardRef(function (_a, forwardedRef) {
    ...
    var internalTextboxId = React.useId();
    var debounceValue = React.useDeferredValue(internalValue);
    var _j = useFilters(items, debounceValue, filters), filteredItems = _j[0], filteredItemsRef = _j[1];
    var listboxRef = React.useRef(null);
    var comboboxInputRef = React.useRef(null);
    var _k = useInternalSelectedItem(selectedItem), internalSelectedItem = _k[0], setSelectedItem = _k[1];
    var setIsExpandedStates = React.useCallback(function (state) { return (setIsExpanded ? setIsExpanded(state) : setInternalIsExpanded(state)); }, [setIsExpanded]);
...
exports.DatalistInput = DatalistInput;
...
exports.useComboboxHelpers = useComboboxHelpers;
